...
//hash array function
        ...
        worksheet.getSelectedMarksAsync().then(function(marks) {
            ...
            const lat2 = latitude[1];
            const lon2 = longitude[1];
            console.log(lat2);
            console.log(lon2);
            ...
            // const trans_M = document.getElementById("transportmode").value;
            const time_m = Number(time_1);
            const time_s = time_m * 60;
            ...
            var popup = marker.bindPopup('<b>Hello</b><br />I am here.');
            popup.openPopup();
            var marker = L.marker([lat1, lon1]).addTo(mymap);
              ...
              async function sendreq() {
                axios({
                    ...
                    // http://docs.traveltimeplatform.com/reference/time-map/#response-body-json-attributes
                      ...
                      var polygon = L.polygon(shapesCoords, { color: '#FF1493' });
                      polygon.addTo(mymap);
